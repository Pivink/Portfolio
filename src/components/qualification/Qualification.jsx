                    ...
                    <div className={toggleState === 1 ? 'qualification__content qualification__content-active' : "qualification__content"}>
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Multanimal Modi College</span>
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">Noida Institute Of Engneering and Technology</span>
                                <div className="qualification__calender">
                                    <i className='uil uil-calendar-alt'></i>2023 - 2025
                                </div>
                            </div>
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Cloud Computing Intern</h3>
                                <span className="qualification__subtitle">Acmegrade</span>
                                <div className="qualification__calender">
                                    <i className='uil uil-calendar-alt'></i>7 months
                                </div>
                            </div>
